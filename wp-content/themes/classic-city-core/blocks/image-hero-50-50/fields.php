	...
	array(
		...
		'fields'                => array(
			...
			array(
				...
				'name'          => 'image_align',
				'type'          => 'select',
				'instructions'  => __( 'Which part of the photograph survives the crop. `cover` discards whatever does not fit the panel; this picks which end it keeps. Centre is the browser default and what every block rendered before this field existed.', 'classic-city-core' ),
				'choices'       => array(
					'top-left'      => __( 'Top Left', 'classic-city-core' ),
					'top-center'    => __( 'Top Centre', 'classic-city-core' ),
					'top-right'     => __( 'Top Right', 'classic-city-core' ),
					'center-left'   => __( 'Middle Left', 'classic-city-core' ),
					'center-center' => __( 'Middle Centre', 'classic-city-core' ),
					'center-right'  => __( 'Middle Right', 'classic-city-core' ),
					'bottom-left'   => __( 'Bottom Left', 'classic-city-core' ),
					'bottom-center' => __( 'Bottom Centre', 'classic-city-core' ),
			...
			array(
				...
				'type'              => 'select',
				'instructions'      => __( 'Shape of the media panel at desktop. "Hug text" is the historic behaviour: the panel takes whatever height the text column happens to be, so a short intro paragraph produces a very shallow band. Any fixed ratio pins the panel instead and centres it beside the text.', 'classic-city-core' ),
				'choices'           => array(
